...
typedef struct{const char*name,*version,*category;int essential;const char*description;}package_t;
#define PACKAGE_ROW(name,version,category,essential,description) {name,version,category,essential,description},
