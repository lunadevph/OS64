...
static unsigned char installed_image[32768];
...
typedef struct{const char*name,*version,*category,*license,*upstream,*payload;int essential;const char*description;}package_t;
#define PACKAGE_ROW(name,version,category,license,upstream,payload,essential,description) {name,version,category,license,upstream,payload,essential,description},
